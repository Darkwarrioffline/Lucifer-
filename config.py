...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "6136986075:AAEkmQaeSZc02HGGZqsXYYyaVHYF3qKeHJs")
...
#Your db channel Id
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1001966397479"))
...
#start message
START_MSG = os.environ.get("START_MESSAGE", "Hello {first}\n\nI'm Super File Saver For @Ongoing_Anime_2024.")
try:
    ADMINS=[]
...
#Force sub message 
FORCE_MSG = os.environ.get("FORCE_SUB_MESSAGE", "Hello {first}\n\n<b>You need to join in my Channel/Group to use me\n\nKindly Please join Channel< /@Ongoing_Anime_2024>")
